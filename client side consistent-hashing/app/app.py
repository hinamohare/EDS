...
###############################      config information     #############################################
"""app.config['SQLALCHEMY_DATABASE_URI']  = 'mysql+pymysql://root:hina@192.168.99.100:3306/expensedb'
...
class ExpenseRecord(db.Model):
    ...
    submit_date = db.Column('submit_date', db.String(50))
...
def post_record():
    ...
    record = ExpenseRecord(id,name, email, category, description, link, estimated_costs,submit_date)
    db.create_all();
